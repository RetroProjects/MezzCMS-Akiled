	...
	Class Admin
	{
			...
			if (isset($_GET['user'])) {
				if ($config['hotelEmu'] == 'arcturus')
				{
					...
					{	
						...
						{
							Admin::error("¡Usuario no encontrado!"); exit;
						}
					}
				}
				else
		...
		public static function EditItem($variable)
		{
			...
			if (isset($_GET['id'])) {
					...
					{
						Admin::error("¡Item no encontrado!"); exit;
					}
				}
			...
			public static function EditFurniture($variable)
		{
			...
			if (isset($_GET['id'])) {
					...
					{
						Admin::error("¡Furniture no encontrado!"); exit;
					}
				}
		...
		public static function EditRolePlayItems($variable)
		{
			...
			if (isset($_GET['id'])) {
					...
					{
						Admin::error("RolePlay Items no encontrado!"); exit;
					}
				}
		...
		public static function EditHappyHour($variable)
		{
			global $dbh,$config;
					...
					{
						Admin::error("¡Pagina no encontrado!"); exit;
					}
		...
		public static function EditGroup($variable)
		{
			...
			if (isset($_GET['id'])) {
					...
					{
						Admin::error("Group no encontrado!"); exit;
					}
				}
		...
		public static function EditBadges($variable)
		{
			...
			if (isset($_GET['badges'])) 
			{
				...
				{
					Admin::error("No se a encontrado la placa"); exit;
				}
			}
		}
		public static function EditPublicRoom($variable)
		{
			...
			if (isset($_GET['room'])) 
			{
				...
				{
					Admin::error("No se a encontrado la sala"); exit;
				}
			}
		}
		public static function EditSection($variable)
		{
			...
			if (isset($_GET['section'])) 
			{
				...
				{
					Admin::error("No se a encontrado la sección"); exit;
				}
			}
		}
		...
		public static function EditNews($variable)
		{
			...
			if (isset($_GET['news'])) 
			{
				...
				{
					Admin::error("No se ha encontrado la noticia"); exit;
				}
			}
		}
		...
		public static function EditRoomOwner($variable)
		{
			...
			if (isset($_GET['id'])) {
					...
					{
						Admin::error("¡Sala no encontrado!"); exit;
					}
				}
		...
		public static function EditComandos($variable)
		{
			...
			if (isset($_GET['id'])) {
					...
					{
						Admin::error("¡Comando no encontrado!"); exit;
					}
				}
		...
		public static function ViewTicket($variable)
		{
			...
			if (isset($_GET['ticket'])) 
			{
				...
				{
					Admin::error("No se ha encontrado el ticket"); exit;
				}
			}
		}
