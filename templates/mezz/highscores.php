...
<head>
    ...
    <title><?=$config['hotelName']?>: Ranking</title>
</head>
                    ...
                    <div class="page-content-collider-content highscores">
                        <div class="page-content-collider-content-highscores-ranking">
                            ...
                            <div class="page-content-collider-content-highscores-ranking-content">
                                    ...
                                    <img src="/assets/images/user-space/credits.png">
                                        ...
                                        <a href="/profile/<?= filter($belcr_row['username']) ?>"><p class="page-content-collider-content-highscores-ranking-content-item-username"><?= filter($belcr_row['username']) ?></p></a>
                        ...
                        <div class="page-content-collider-content-highscores-ranking">
                            ...
                            <?php 
                                ...
                                <div class="page-content-collider-content-highscores-ranking-content-item-column">
                                <a href="/profile/<?= filter($belcr_row10['username']) ?>"><p class="page-content-collider-content-highscores-ranking-content-item-username"><?= filter($belcr_row10['username']) ?></p></a>
                        ...
                        <div class="page-content-collider-content-highscores-ranking">
                            ...
                            <?php 
                                ...
                                <div class="page-content-collider-content-highscores-ranking-content-item-column">
                                <a href="/profile/<?= filter($belcr_row11['username']) ?>"><p class="page-content-collider-content-highscores-ranking-content-item-username"><?= filter($belcr_row11['username']) ?></p></a>
