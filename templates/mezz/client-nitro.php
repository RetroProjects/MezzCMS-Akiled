	...
	<head>
	    ...
	    <link rel="stylesheet" href="https://akiled.org//templates/sloptv4.2/client/css/css1.css">
	</head>
	    ...
	    <div class="button-news" style="z-index:1;!important">
	        <div id="lista-btns" style="display: none; z-index:1;">
	            ...
	            <div class="content" id="ver-content-ranking" style=" z-index:1;">
	                <div class="info-btn" style=" z-index:1;">
	                    <img src="https://dev.akiled.org//templates/sloptv4.2/client/images/ranking.png" alt="">
	                    <b>SALÓN DE LA FAMA</b>
	                </div>
	            </div>
	            <div class="content" id="ver-content-retos" style=" z-index:1;">
	                <div class="info-btn" style=" z-index:1;">
	                    <img src="https://dev.akiled.org//templates/sloptv4.2/client/images/retosh.gif" alt="">
	        ...
	        <div class="content" style=" z-index:1;">
	            <div class="info-btn boton-mostrar" id="btn-hnews" style="display: flex; z-index:1;">
	                <img src="https://dev.akiled.org//templates/sloptv4.2/client/images/hnews.png" style="width: 40px;object-fit: cover;">
	                <b>Utilidades</b>
	            </div>
	            <div class="content-btn-util" id="abrirbtn">
	                <img class="ver-estado" src="https://dev.akiled.org//templates/sloptv4.2/client/images/cerrar.png" alt="" id="cerrar" style="display:block;">
	                <img class="ver-estado" src="https://dev.akiled.org//templates/sloptv4.2/client/images/abrir.png" alt="" id="abrir" style="display:none;">
	            </div>
	        </div>
	    </div>
